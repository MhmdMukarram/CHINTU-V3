...
module.exports = {
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '៚ᴠɪʜͥᴀɴͣɢͫᴀ ʏᴛ͢⁸⁵⁴¹⃟✦⃝̮̮〽️' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '៚ᴠɪʜͥᴀɴͣɢͫᴀ ʏᴛ͢⁸⁵⁴¹⃟✦⃝̮̮〽️' : process.env.CAPTION,
