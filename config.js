...
module.exports = {
    VERSION: 'CHINTU 3.0',
    CHANNEL: 'https://t.me/',
    SESSION: process.env.CHINTU_SESSION === undefined ? '' : process.env.CHINTU_SESSION,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '𝙲𝙷𝙸𝙽𝚃𝚄 𝙱𝙾𝚃' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '𝙲𝙷𝙸𝙽𝚃𝚄 𝙱𝙾𝚃' : process.env.CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/N95Zqw4/logo.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/N95Zqw4/logo.jpg' : process.env.ALIVE_LOGO,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'CHINTU USER' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'ChintuBot' : process.env.BOT_NAME,
